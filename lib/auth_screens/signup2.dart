...
class _SignupOwnerState extends State<SignupOwner> {
  ...
  double getResponsiveFont(double screenWidth, double size) =>
      (screenWidth / 375) * size;

  @override
  void initState() {
    super.initState();
    _termsTapRecognizer.onTap = () => Get.toNamed(AppRoutes.terms);
    _privacyTapRecognizer.onTap = () => Get.toNamed(AppRoutes.privacy);
  }
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: CustomButton(
                                title: 'Sign Up',
                                onPressed: () =>
                                    Get.toNamed(AppRoutes.setupYourBusiness),
                              ),
                            ),
                            SizedBox(height: h * 0.04),
                            Row(
