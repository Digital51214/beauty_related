...
import 'package:beauty_related/clientSites/client_bookings.dart';
import 'package:beauty_related/clientSites/reviews_screen_client.dart';
...
class _ClientBottomNavigationScreenState extends State<ClientBottomNavigationScreen> {
  int selectedIndex = 0;

  final List<Widget> screens = const [
    ClientHomescreen(),
    ClientReviewsScreen(),
    ClientBookingsScreens(),
    ClientProfileScreen(),
  ];
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          navItem('assets/images/reviews.png', "Reviews", 1, baseSize, w, h),
